...
# O student_web depende de packages/shared_core via Dart pub workspace, então o
...
# domínio (ex.: "/student/" atrás de um proxy compartilhado com outras
...
COPY --from=build /workspace/student_web/build/web /usr/share/nginx/html
